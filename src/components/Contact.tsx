      ...
      <div className="max-w-7xl mx-auto px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="font-headline text-5xl mb-10 leading-tight">Iniciemos una Conversación</h2>
            ...
            <div className="space-y-12">
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  >
                    Garibaldi 204, Pb B <br />Quilmes, Buenos Aires, Argentina
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <p className="text-lg font-headline underline underline-offset-8 decoration-tertiary-fixed-dim/30">contacto@leivaelian.com</p>
                </div>
              </div>
          ...
          <motion.div 
            ...
            className="bg-surface-container-lowest p-12 text-on-surface"
          >
            <form className="space-y-8" onSubmit={(e) => e.preventDefault()}>
              <div className="group">
                ...
                <input 
                  className="w-full bg-transparent border-0 border-b border-outline-variant/40 focus:ring-0 focus:border-on-tertiary-container px-0 py-3 text-lg placeholder:text-outline-variant transition-all" 
              ...
              <div className="group">
                ...
                <select className="w-full bg-transparent border-0 border-b border-outline-variant/40 focus:ring-0 focus:border-on-tertiary-container px-0 py-3 text-lg transition-all appearance-none">
              ...
              <div className="group">
                ...
                <textarea 
                  className="w-full bg-transparent border-0 border-b border-outline-variant/40 focus:ring-0 focus:border-on-tertiary-container px-0 py-3 text-lg placeholder:text-outline-variant transition-all resize-none" 
              ...
              <button 
                ...
                className="w-full bg-primary text-on-primary py-5 rounded-sm font-label uppercase tracking-[0.3em] text-sm hover:bg-primary-container transition-all mt-6 flex items-center justify-center gap-2"
              >
                <svg 
                  viewBox="0 0 24 24" 
